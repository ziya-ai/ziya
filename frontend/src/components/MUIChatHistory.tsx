...
const MUIChatHistory = () => {
  ...
  const handleForkConversation = async (conversationId: string) => {
    // Delegates to ChatContext.forkConversation, which handles:
    // - shell hydration from IDB
    // - optimistic state update + navigation
    // - IDB persist with rollback on failure
    // - dirty-tracking for server dual-write
