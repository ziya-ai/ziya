...
"""
        ...
        self.assertEqual(difflib_result["changes_written"], normal_result["changes_written"],
                        f"changes_written is inconsistent: difflib={difflib_result['changes_written']}, normal={normal_result['changes_written']}")
