...
class DiffRegressionTest(unittest.TestCase):
    ...
    def test_MRE_content_duplication_corruption(self):
        """Test case for content duplication corruption where added lines appear twice"""
        self.run_diff_test('MRE_content_duplication_corruption')
        
    def test_MRE_indented_context(self):
        self.run_diff_test('indented_context')
