...
_VARS: List[EnvVar] = [
    ...
    EnvVar("ZIYA_AST_TIMEOUT", float, 180, EnvCategory.FEATURES,
           "Timeout in seconds for full AST indexing pass."),
    EnvVar("ZIYA_AST_FILE_CAP", int, 50000, EnvCategory.FEATURES,
           "Maximum number of files the AST indexer will process."),
    ...
    # ── Embeddings / PDF RAG ──────────────────────────────────────────────
    EnvVar("ZIYA_EMBEDDING_PROVIDER", str, "auto", EnvCategory.GROUNDING,
           "Embedding provider: 'auto', 'bedrock', or 'local'."),
    EnvVar("ZIYA_EMBEDDING_MODEL", str, None, EnvCategory.GROUNDING,
           "Bedrock embedding model ID."),
    EnvVar("ZIYA_EMBEDDING_REGION", str, "us-east-1", EnvCategory.GROUNDING,
    ...
    EnvVar("ZIYA_DEBUG_CHUNKS", bool, False, EnvCategory.LOGGING,
    ...
    EnvVar("ZIYA_SYMLINK_HOPS", int, 1, EnvCategory.INTERNAL,
           "Maximum symlink hops during directory traversal.", user_facing=False),
    EnvVar("ZIYA_GITIGNORE_TIMEOUT", float, 60, EnvCategory.INTERNAL,
           "Timeout (seconds) for .gitignore parsing.", user_facing=False),
    EnvVar("ZIYA_FILE_LIST_TIMEOUT", float, 120, EnvCategory.INTERNAL,
           "Timeout (seconds) for generating file listings.", user_facing=False),
    EnvVar("ZIYA_ESTIMATE_TIMEOUT", float, 15, EnvCategory.INTERNAL,
           "Timeout (seconds) for token estimate calculations.", user_facing=False),
    EnvVar("ZIYA_EXPLICIT_ROOT", str, None, EnvCategory.INTERNAL,
           "Flag: project root was explicitly set by --root, not auto-detected.",
           user_facing=False),
    EnvVar("ZIYA_VERSION", str, None, EnvCategory.INTERNAL,
           "Version override set by wrapper scripts (e.g. toolbox).", user_facing=False),
    EnvVar("ZIYA_MEMORY_EVAL_MODEL", str, None, EnvCategory.INTERNAL,
           "Model override for memory evaluation/extraction.", user_facing=False),
