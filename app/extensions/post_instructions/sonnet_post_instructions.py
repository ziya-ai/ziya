...
IMPORTANT: Apply changes to targets listed under "Writable paths (effective)" with the available direct-write tool. Present changes to all other targets in git diff format when it makes sense to do so.
